#!/usr/bin/env python3
"""P25 fresh pawnless-core exact-world constitution.
...
def out_path(argv):
    ...
    raise SystemExit("P25_CORE_OUT_MISSING")

if __name__=="__main__":
    p=out_path(sys.argv);base.main();x=json.loads(p.read_text())
    x["schema"]="c3x-p25-core-part-v1"
    x["scientific_stage"]="C3X 0.7.0-G9.4-P25"
    ...
    x["freshness"]={"generation_index_offset":OFFSET,"p20_cells_reused":False,"p21_cells_reused":False,"p22_cells_reused":False,"p23_cells_reused":False,"p24_cells_reused":False}
    ...
    print("P25_CORE_PART_PASS",len(x["candidates"]),x["pool_sha256"])
